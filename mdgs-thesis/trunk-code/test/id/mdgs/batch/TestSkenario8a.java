...
public class TestSkenario8a {
	...
	public static void main(String[] args) {
		...
		//------------------------------
		IClassify<?, Entry> net = c3;
		ITrain trainer = train3;
		//------------------------------
		...
		do {
			...
			//test with training
			cm1 = TestBatch.doTest(net, train, nclass);
			err[0] = 1 - cm1.getAccuracy();
			
			//test with validation set
			cm1 = TestBatch.doTest(net, test, nclass);
			err[1] = 1 - cm1.getAccuracy();
