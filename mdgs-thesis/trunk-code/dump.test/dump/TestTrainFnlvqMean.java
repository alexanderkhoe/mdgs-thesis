...
import id.mdgs.neural.fnlvq.crisp.FnlvqCrispMean;
...
public class TestTrainFnlvqMean {
	
//	@Test
	public void testIris(){
		utils.header("Test TrainFnlvq() with Iris"); 
		NeuralDataSet dataset = new CSVNeuralDataSet(Parameter.IRIS_DATA, 4, 1, 
		...
		int in = 4;
		int out= stat.size();
		FnlvqCrisp network = new FnlvqCrispMean(in, out);
