...
Pengukuran ECG dilakukan dengan menggunakan sandapan (lead), yaitu sepasang atau
...
\noindent Jenis sandapan ada 2, yaitu;
\begin{enumerate}
   \item \textit{unipolar}; yaitu sandapan dimana 1 elektrode ditempatkan di
   ...
   \item \textit{bipolar};yaitu sandapan 2 elektrode dimana ditempatkan terpisah
...
Ada bermacam variasi alat perekam ECG dari sandapan-3, sandapan-5 maupun
sandapan-12. standar ECG yang umum digunakan adalah ECG sandapan-12 (12-lead)
dimana terdiri dari sandapan I (LA ke RA),II (LL ke RA),III (LL ke LA), sandapan
tambahan (\textit{augmented lead}) yang bersifat unipolar; aVF, aVR, aVL, dan 
sandapan prekordial ($V_1 \dots V_6$), dapat dilihat pada \pic~\ref{fig:ecglead},\ref{fig:einthoventri}\footnotemark[\value{footnote}]. Yang perlu dipahami
disini adalah sandapan-12 hanya memiliki jumlah elektrode sebanyak 10 buah
...
Aritmia.sehingga hasil dari pengenalan ECG hanya bisa dimanfaatkan sebagai
...
jantung-Aritmia yakni RBBB}”, dan tidak lebih dari itu.
