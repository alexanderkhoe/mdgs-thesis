...
public class Msa {
	...
	private ITrain trainer;
	
	public Msa(final ITrain trainer){
		this(trainer, Msa.DEFAULT_THRESHOLD);
	}
	
	public Msa(final ITrain trainer, double threshold){
		/*assume each class has single code vector*/
		int numclass = trainer.getNumberOfClass();
