...
public class FuzzyNode implements Node {
	...
	public void set(double min, double mean, double max){
		this.min = min;
		this.mean = mean;
		this.max = max;			
	}
	...
	public void randomize(double min, double max){
		double d = max - min;
		double d33 = 0.33 * d; 
		set(MathUtils.randomDouble(min, min + d33),
			MathUtils.randomDouble(min + d33, max - d33),
			MathUtils.randomDouble(max-d33, max));
	}		
