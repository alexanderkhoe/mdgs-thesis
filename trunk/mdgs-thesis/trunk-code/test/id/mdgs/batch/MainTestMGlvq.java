...
public class MainTestMGlvq {
	...
	public static PrintWriter createWriter(String tag) throws IOException{
		return new PrintWriter(new BufferedWriter(new FileWriter(
				utils.getDefaultPath() + "/resources/output/resume." + tag + "." +
						MainTestMGlvq.class.getSimpleName(), true)));	
	}
	...
	public static int MAX_ATTEMPT 	  = 1;
	

	public static void testMGlvq() throws IOException{
